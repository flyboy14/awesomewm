...
function show_smth(tiitle, teext, icoon, timeeout, baackground, fooreground, foont, poosition)
   ...
   , bg = baackground or "#383C4A", fg = fooreground or "#dedede", font = foont or beautiful.font, position = poosition or "top_right", opacity = 1 }
 end
...
myweather = lain.widgets.weather_colorarrows({
    ...
    settings = function()
        ...
        widget:set_markup(markup(unitscolor, "<span font='Fixed 14' background='#C2C2A4'> <span rise='1600' font='Clean 9'><span color='#5e5e5e'>" .. descr .. " <span font='Visitor TT2 BRK 10'>" .. units .. "°C </span></span></span></span>"))
    end
})
