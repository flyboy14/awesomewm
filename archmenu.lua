 local menu98edb85b00d9527ad5acebe451b3fae6 = {
     ...
     {"Google Drive", "xdg-open \"Google Drive\"", "///opt/grive-tools/GoogleDrive.png" },
     {"Google Drive Indicator", "/opt/grive-tools/grive-indicator ", "///opt/grive-tools/GoogleDrive.png" },
     {"Grive Setup", "/bin/bash /opt/grive-tools/grive-setup", "///opt/grive-tools/grive.png" },
