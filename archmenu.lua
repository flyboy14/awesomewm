 local menu98edb85b00d9527ad5acebe451b3fae6 = {
     ...
     {"Gesture Manager X", "/usr/bin/gesture-manager-x", "///usr/share/gesture-manager-x/icon.svg" },
 ...
 local menu251bd8143891238ecedc306508e29017 = {
     {"LSI Steam", "/usr/bin/lsi-steam ", "/usr/share/icons/hicolor/16x16/apps/steam.png" },
     ...
     {"Linux Steam Integration", "lsi-settings", "/usr/share/icons/hicolor/16x16/apps/steam.png" },
 ...
 local menuc8205c7636e728d448c2774e6a4a944b = {
     ...
     {"Skype Preview", "/usr/bin/skypeforlinux ", "/usr/share/icons/hicolor/16x16/apps/skypeforlinux.png" },
 ...
 local menu52dd1c847264a75f400961bfb4d1c849 = {
     ...
     {"BlueJeans", "\"/opt/BlueJeans/bluejeans-v2\" ", "/usr/share/icons/hicolor/16x16/apps/bluejeans-v2.png" },
     ...
     {"Spotify Tray Icon", "spotify-tray", "/usr/share/pixmaps/spotify-client.png" },
     {"Twitch", "/opt/Twitch/Twitch", "///opt/Twitch/resources/app/icon.png" },
